...
abstract class Staff
{
	...
	public function getSurname($value)
		...
		if($GLOBALS['USE_DISPLAY_NAME'])
			{
			$fio = explode(" ", $value);
			if(preg_match("/([іІєЄїЇёA-zА-я-]+[\s]{1}[іІєЄїЇёA-zА-я]{1}.)[\s]{1}([іІєЄїЇёA-zА-я-]+)/u", $value))
				return $fio[2];
			else
				return $fio[0];
			}
	...
	public static function makeNameUrlFromDn($DN, $Title="")
		...
		if($GLOBALS['USE_DISPLAY_NAME'])
			{
			$DN=preg_replace("/([іІєЄїЇёA-zА-я-]+)[\s]{1}([іІєЄїЇёA-zА-я-]+[\s]{1}[іІєЄїЇёA-zА-я-]+)(CN.*)/u", "<a href=\"newwin.php?menu_marker=si_employeeview&dn=\\3\" data-lightview-type=\"iframe\" data-lightview-options=\"width: '80%', height: '100%', keyboard: {esc: true}, skin: 'light'\" class=\"lightview in_link\"><span class='surname'>\\1</span> \\2</a>", $Title.$DN);
			$DN=preg_replace("/([іІєЄїЇёA-zА-я-]+[\s]{1}[іІєЄїЇёA-zA-я]{1}.)[\s]{1}([іІєЄїЇёA-zА-я-]+)(CN.*)/u", "<a href=\"newwin.php?menu_marker=si_employeeview&dn=\\3\" data-lightview-type=\"iframe\" data-lightview-options=\"width: '80%', height: '100%', keyboard: {esc: true}, skin: 'light'\" class=\"lightview in_link\"><span class='surname'>\\2</span> \\1</a>", $DN);	
			$DN=preg_replace("/([іІєЄїЇёA-zA-я0-9№\s-]{1,})(CN.*)/u", "<a href=\"newwin.php?menu_marker=si_employeeview&dn=\\2\" data-lightview-type=\"iframe\" data-lightview-options=\"width: '80%', height: '100%', keyboard: {esc: true}, skin: 'light'\" class=\"lightview in_link\"><span class='surname'> \\1</span></a>", $DN);		
			$DN=preg_replace("/^CN=([іІєЄїЇёA-zA-я0-9\s\.-]{1,})(.*)$/u", "<a href=\"newwin.php?menu_marker=si_employeeview&dn=\\0\" data-lightview-type=\"iframe\" data-lightview-options=\"width: '80%', height: '100%', keyboard: {esc: true}, skin: 'light'\" class=\"lightview in_link\"><span class='surname'> \\1</span></a>", $DN);		
			}
		else
			{
			$DN=preg_replace("/^[A-Za-z]+=*([іІєЄїЇёА-яA-z0-9\s-.]+),[\S\s]+$/eu", "'<a href=\"newwin.php?menu_marker=si_employeeview&dn='.'\\0'.'\" data-lightview-type=\"iframe\" data-lightview-options=\"width: '80%', height: '100%', keyboard: {esc: true}, skin: 'light'\" class=\"lightview in_link\">___\\1</a>'", $DN);
			$DN=preg_replace("/___([іІєЄїЇёA-zА-я-]+)[\s]{1}([ёA-zА-я-]+[\s]{1}[іІєЄїЇёA-zА-я-]+)/u", "<span class='surname'>\\1</span> \\2", $DN);
			//Для формата Имя О. Фамилия
			$DN=preg_replace("/___([іІєЄїЇёA-zА-я-]+[\s]{1}[іІєЄїЇёA-zA-я]{1}.)[\s]{1}([ёA-zА-я-]+)/u", "<span class='surname'>\\2</span> \\1", $DN);	
			}	
		return $DN;
		}
...
/////function makeBirth  добавил я
	public static function makeBirth($Val)
		{
		if($Val)
			return $Val;
		else
	...
	public static function printUserTableRow($Staff, $key, $Vars)
		...
		// Строки таблицы     задается порядок полей в таблице
		//-------------------------------------------------------------------------------------------------------------
